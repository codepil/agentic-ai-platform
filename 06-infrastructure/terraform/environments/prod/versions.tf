# -----------------------------------------------------------------------------
# Prod Environment — Provider & Backend Versions
# -----------------------------------------------------------------------------
...
terraform {
  ...
  # Use a SEPARATE state key from dev to prevent cross-environment state
  # corruption.
  #
  # Pre-requisites:
  ...
  #   key            = "agentic-ai-platform/prod/terraform.tfstate"
  #   region         = "us-east-1"
  #   encrypt        = true
